...
class _CupertinoControlsState extends State<CupertinoControls> {
  ...
  Widget build(BuildContext context) {
    ...
    final barHeight = orientation == Orientation.portrait ? ScreenAdapter.height(30.0) : ScreenAdapter.height(47.0);
    final buttonPadding = orientation == Orientation.portrait ? ScreenAdapter.height(16.0) : ScreenAdapter.height(24.0);
