...
class _RenderCheckbox extends RenderToggleable {
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    const Offset start = Offset(_kEdgeSize * 0.15 * 1.5, _kEdgeSize * 0.45);
    const Offset mid = Offset(_kEdgeSize * 0.4 * 1.1, _kEdgeSize * 0.7 * 0.95);
    const Offset end = Offset(_kEdgeSize * 0.85 * 0.92, _kEdgeSize * 0.25 * 1.3);
    if (t < 0.5) {
